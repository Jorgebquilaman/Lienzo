...
namespace Lienzo.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260802202122_AddAccessoryConfirmation")]
    partial class AddAccessoryConfirmation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.Classroom", b =>
                {
                    ...
                    b.Property<float?>("MapPositionX")
                        .HasColumnType("real")
                        .HasColumnName("posicion_x");

                    b.Property<float?>("MapPositionY")
                        .HasColumnType("real")
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.ClassroomAccessory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.KeyDelivery", b =>
                {
                    ...
                    b.Property<Guid>("DeliveredById")
                        .HasColumnType("uuid")
                        .HasColumnName("entregado_por_usuario_id");

                    b.Property<string>("DeliveredToName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("entregado_a_nombre");

                    b.Property<Guid?>("DeliveredToUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("entregado_a_usuario_id");
                    ...
                    b.HasIndex("ClassroomId")
                        .HasDatabaseName("ix_entregas_llaves_aula");

                    b.HasIndex("DeliveredToUserId")
                        .HasDatabaseName("ix_entregas_llaves_entregado_a");
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.ProcessedEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.Receso", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime?>("AccessoriesConfirmedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("confirmacion_accesorios_recibida_en");

                    b.Property<string>("AccessoryConfirmationToken")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.Property<bool>("RequiresAccessoryConfirmation")
                        .HasColumnType("boolean")
                        .HasColumnName("requiere_confirmacion_accesorios");

                    b.Property<DateTime?>("SourceEmailDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("email_origen_fecha");

                    b.Property<string>("SourceEmailFrom")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.Property<string>("SourceEmailUid")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.ReservationAccessory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("reserva_accesorios", (string)null);
                });
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.SystemSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.ReservationAccessory", b =>
                {
                    b.HasOne("Lienzo.Domain.Entities.Reservation", "Reservation")
                        .WithMany("ReservationAccessories")
                        .HasForeignKey("ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.Classroom", b =>
                {
                    b.Navigation("ClassroomAccessories");
            ...
            modelBuilder.Entity("Lienzo.Domain.Entities.Reservation", b =>
                {
                    b.Navigation("ReservationAccessories");
                });
